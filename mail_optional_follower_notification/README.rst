...
notify followers on mail.compose.message. By default, Odoo will notify
all followers automatically.
By setting the default value of Field notify_followers to False this behaviour can be inverted.
